(function ($) {
	$.fn.zepto_china_area = function () {
		// var selectContent = '<div><select id="loc_province" style="width:100%;"></select></div><div><select id="loc_city" style="width:100%;"></select></div><div><select id="loc_town" style="width:100%;"></select></div>'
		...
		function showLocation(province , city , town) {
			...
			$('.loc_province').change(function() {
				$('select.loc_city').empty();
				$('select.loc_city').append(title[1]);
				loc.fillOption('loc_city' , '0,'+$('select.loc_province').val());
				$('select.loc_city').change()
				//$('input[@name=location_id]').val($(this).val());
			})
			
			$('select.loc_city').change(function() {
				$('select.loc_town').empty();
				$('select.loc_town').append(title[2]);
				loc.fillOption('loc_town' , '0,' + $('select.loc_province').val() + ',' + $('select.loc_city').val());
				//$('input[@name=location_id]').val($(this).val());
			})
